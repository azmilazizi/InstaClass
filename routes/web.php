...
Route::get('/myprofile', [SubjectController::class, 'findSubject'])->middleware('auth');;
...
Route::get('joinclass/{subject_id}', [StudentController::class, 'joinClass'])->middleware('auth');;
